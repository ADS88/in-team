...
namespace Server.Api.Migrations
{
    ...
    [Migration("20210901080404_LinkedSurveyToIteration")]
    partial class LinkedSurveyToIteration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Api.Entities.AchievedState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Server.Api.Entities.AchievedState", b =>
                {
                    ...
                    b.HasOne("Server.Api.Entities.Iteration", "Iteration")
                        .WithMany()
                    ...
                    b.HasOne("Server.Api.Entities.Team", "Team")
                        .WithMany()
